...
<s:url value="/css/commons/commons.css" var="commons_css" />
<%-- 各画面用CSS --%>
<s:set var="disp_css">
	<tiles:getAsString name="disp_css" ignore="true" />
</s:set>
<s:url value="/css/%{disp_css}" var="disp_css_url" />
...
<link rel="stylesheet" href="${commons_css}" type="text/css" />
